...
try {
	...
	$statement = $mysqli->prepare("select year(stamp), month(stamp), day(stamp), hour(stamp), minute(stamp), second(stamp), temperature_1, temperature_2, temperature_3, temperature_4, temperature_5 from results");
