...
try {
	...
	$statement = $mysqli->prepare("select year(stamp), month(stamp), day(stamp), hour(stamp), minute(stamp), second(stamp), humidity_1, temperature_1, humidity_2, temperature_2, humidity_3, temperature_3, humidity_4, temperature_4, humidity_5, temperature_5 from results");
